...
client.on('message', message => {
    ...
    if(!message.member.roles.find("name", "kangarouxler") && message.content !== "kangaroux" && message.content !== warnings.variant && message.channel === guild.channels.find("name", "bangaroux")){
        message.delete();
